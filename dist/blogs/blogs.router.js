...
exports.blogsRouter.get('/:blogId/posts', auth_middleware_1.authMiddleware, blogId_validation_1.blogIdBodyValidate, errors_result_middleware_1.handleValidationErrors, blogs_controller_1.blogsController.getPostsByBlogId);
...
exports.blogsRouter.post('/:blogId/posts', auth_middleware_1.authMiddleware, blogId_validation_1.blogIdBodyValidate, ...posts_validation_1.validatePostFields, errors_result_middleware_1.handleValidationErrors, blogs_controller_1.blogsController.createPost);
