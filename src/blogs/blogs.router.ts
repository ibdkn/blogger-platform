...
import {postFieldValidationWithBlogId} from "../posts/midlewares/postFields.validation";
...
blogsRouter.post('/:blogId/posts', baseAuthGuard, ...postFieldValidationWithBlogId, inputValidation, postsController.createPostForSpecificBlog);
